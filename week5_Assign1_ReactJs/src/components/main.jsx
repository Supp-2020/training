  ...
  render(){
    ...
    <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
      <div className="col-lg-6 px-0">
        ...
        <p className="lead mb-0"><a href="https://github.com"  className="text-body-emphasis fw-bold">Continue reading...</a></p>
      </div>
    </div>
      ...
      <div className="col-md-6">
        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div className="col p-4 d-flex flex-column position-static">
            ...
            <a href="https://github.com"  className="icon-link gap-1 icon-link-hover stretched-link">
              Continue reading
    ...
    <div className="row g-5">
      <div className="col-md-8">
        ...
        <article className="blog-post">
          ...
          <p className="blog-post-meta">January 1, 2021 by <a href="https://github.com" >Mark</a></p>
        ...
        <article className="blog-post">
          ...
          <p className="blog-post-meta">December 23, 2020 by <a href="https://github.com" >Jacob</a></p>
        ...
        <article className="blog-post">
          ...
          <p className="blog-post-meta">December 14, 2020 by <a href="https://github.com" >Chris</a></p>
        ...
        <nav className="blog-pagination" aria-label="Pagination">
          <a className="btn btn-outline-primary rounded-pill" href="https://github.com" >Older</a>
        ...
        <div className="position-sticky" style={{top: "2rem;"}}>
          ...
          <div>
            ...
            <ul className="list-unstyled">
              <li>
                <a className="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top" href="https://github.com" >
          ...
          <div className="p-4">
            ...
            <ol className="list-unstyled mb-0">
              <li><a href="https://github.com" >March 2021</a></li>
              <li><a href="https://github.com" >February 2021</a></li>
              <li><a href="https://github.com" >January 2021</a></li>
              <li><a href="https://github.com" >December 2020</a></li>
              <li><a href="https://github.com" >November 2020</a></li>
              <li><a href="https://github.com" >October 2020</a></li>
              <li><a href="https://github.com" >September 2020</a></li>
              <li><a href="https://github.com" >August 2020</a></li>
              <li><a href="https://github.com" >July 2020</a></li>
              <li><a href="https://github.com" >June 2020</a></li>
              <li><a href="https://github.com" >May 2020</a></li>
              <li><a href="https://github.com" >April 2020</a></li>
            </ol>
          </div>
          ...
          <div className="p-4">
            ...
            <ol className="list-unstyled">
              ...
              <li><a href="https://github.com" >Twitter</a></li>
              <li><a href="https://github.com" >Facebook</a></li>
            </ol>
          </div>
        </div>
      </div>
